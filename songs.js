...
songList.set('ghost', {
    'key': 'ghost',
    'title': 'justin bieber<br>-<br>ghost',
...
songList.set('riverFlowsInYou', {
    'key': 'riverFlowsInYou',
    'title': 'yiruma<br>-<br>river flows in you',
    ...
    B3 C4 D4 E4 C5 B4 E4 B4 C5 B4 A4 G4 | A4 A3 B3 C4 E3 A3 C4 D4 | E4 E3 C4 D4 C4 B3 A4 B4 A4 G4 |
    A4 A3 E4 A3 A4 B4 A4 G4 A4 A3 E4 A3 A4 B4 A4 G4 | A4 B4 C5 D5 E5 C5 B4 A4 G4 B3 A4 B4 A4 G4 |
    A4 A3 E4 A3 A4 B4 A4 G4 A4 A3 E4 A3 A4 B4 A4 G4 | A4 B4 C5 D5 E5 C5 B4 A4 G4 B3 A4 A4 B4 A4 G4 |
    
    A4 A3 E4 A3 A4 A4 B4 A4 G4 A4 A3 E4 A3 A4 A4 B4 A4 G4 | A4 B4 C5 D5 E5 C5 B4 A4 G4 B3 A4 A4 B4 A4 G4 |
    A4 A3 E4 A3 A4 A4 B4 A4 G4 A4 A3 E4 A3 A4 B4 A4 G4 | A4 B4 C5 D5 E5 C5 B4 A4 G4 B3 G3 E3 A3 C4 |
    A4 G4 A4 A3 G4 A4 A3 G4 A4 A3 D4 A3 | B3 C4 D4 E4 D4 B3 A3 G3 A3 E3 A3 B3 C4 E3 A3 B3 C4 E3 C4 D4 |
    E4 E3 C4 D4 E4 E3 D4 C4 B3 E3 D4 C4 B3 G3 | C4 A4  G4 A4 A3 G4 A4 A3 E4 A4 A3 E4 A3 | B3 C4 D4 E4 C5 B4 E4 E4 C5 B4 A4 G4 |`,
    'signature': [6, minor],
    'sigLiteral': 'A major',
    'chords': ''
})
...
songList.set('littleTalks', {
    'key': 'littleTalks',
    'title': 'of monsters and men<br>-<br>little talks',
...
songList.set('loveTheWayYouLie', {
    ...
    'title': 'rihanna<br>-<br>love the way you lie',
...
songList.set('letHerGo', {
    'key': 'letHerGo',
    'title': 'passenger<br>-<br>let her go',
...
songList.set('allstar', {
    'key': 'allstar',
    'title': 'smashmouth<br>-<br>allstar',
